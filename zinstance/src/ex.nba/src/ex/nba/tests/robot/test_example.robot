...
#
#  $ bin/test -s ex.nba -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src ex.nba.testing.EX_NBA_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/ex/nba/tests/robot/test_example.robot
#
